            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="tab" role="tabpanel">
                    <div class="tab-content tabs">
                        <div role="tabpanel" class="tab-pane fade in active" id="CompanyClients">
                            <div class="pdng20">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="col-lg-4" id="comCL2">
                                            <div class="ourteamdiver2" id="clListBox">
                                                ...
                                                <div class="clHover">
                                                    <div class="col-md-12"> <a class="hover-eye" data-toggle="tooltip" title="" data-original-title="View Detail"><i class="fa fa-eye"></i></a>
                                                        <button class="hover-eye fa fa-trash" id="deleteClient2" data-toggle="modal" data-target="#deleteClientmodel" title="Remove"></button>
                                                    </div>
                                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="UserClients">
                            <div class="panel widget">
                                <div class="">
                                    <div class="col-lg-4" id="comCL4">
                                        <div class="ourteamdiver2" id="clListBox">
                                            ...
                                            <div class="clHover">
                                                <div class="col-md-12"> <a class="hover-eye" data-toggle="tooltip" title="" data-original-title="View Detail"><i class="fa fa-eye"></i></a>
                                                    <button class="hover-eye fa fa-trash" id="deleteClient4" data-toggle="modal" data-target="#deleteClientmodel" title="Remove"></button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4" id="comCL5">
                                        <div class="ourteamdiver2" id="clListBox">
                                            ...
                                            <hr class="rulerourtema">
                                            <div class="imgeourteamperson2"> <img src="img/testi_07.png"> </div>
                                            <h3 class="ourteamjopposition22 text-center2 col97be2e">Lewis Sun </h3>
                                            <div class="clHover">
                                                <div class="col-md-12"> <a class="hover-eye" data-toggle="tooltip" title="" data-original-title="View Detail"><i class="fa fa-eye"></i></a>
                                                    <button class="hover-eye fa fa-trash" id="deleteClient5" data-toggle="modal" data-target="#deleteClientmodel" title="Remove"></button>
                                                </div>
                                            </div>
