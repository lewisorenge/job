<template>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 pull-right no-padding">
                <div class="tab" role="tabpanel">
                    <!-- Tab panes -->
                    <div class="tab-content tabs">
                        <div role="tabpanel" class="tab-pane fade" id="ContractStarted">
                            <div class="">
                                    ...
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#" title="">
                                        <div class="col-sm-3 brdRight no-padmr" style=" margin-top: 10px;">
                                            ...
                                            <div class="col-lg-6 ad-padmr" style="">
                                                <p class="mrgn0">Job Name
                                                    <br>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-sm-3 brdRight ">
                                            <h4 style="font-size:15px"> Concept</h4>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="ContractDone">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="ContractDeliverd">
                            <div class="" style=" margin-top: 25px;">
                                <div class="row mrgn30-0 projectRow no-padmr" style=" border-left: 4px solid #9dc23a; text-align:center;">
                                    <a href="javascript:void(0);" title="">
                                        ...
                                        <div class="col-sm-1 " style=" margin-top: 10px;width:20%;height:106px">
                                            <h4>Review</h4> <img src="img/149962454497.png" class="img-responsive">
                                        </div>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane fade" id="ContractDisputs">
                            <div class="" style=" margin-top: 25px;">
                                <div class="row mrgn30-0 projectRow no-padmr" style=" border-left: 4px solid #9dc23a;">
                                    <a href="javascript:void(0);" title="">
                                        <div class="col-sm-3 brdRight no-padmr" style=" margin-top: 10px;">
                                        ...
                                        <div class="col-sm-2" style="text-align: center;">
                                            <h4>Tickets</h4>
                                            <button style="padding: 10px 15px;border-radius: 10px;" type="button" class="btn btn-primary btn-sm">Open Ticket</button>
                                        </div>
                                    </a>
                                </div>
                                <div class="row mrgn30-0 projectRow no-padmr" style=" border-left: 4px solid #9dc23a;">
                                    <a href="javascript:void(0);" title="">
                                        ...
                                        <div class="col-sm-2" style="text-align: center;">
                                            <h4>Tickets</h4>
                                            <button style="padding: 10px 15px;border-radius:10px;" type="button" class="btn btn-primary btn-sm">Ticket ID</button>
                                            <div style=" margin-top:7px;">
                                                <button style="padding: 10px 15px;border-radius:10px;" type="button" class="btn btn-primary btn-sm">Answer 2</button>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="ContractCanceled">
                            <div class="" style=" margin-top: 25px;">
                                <div class="row mrgn30-0 projectRow no-padmr" style=" border-left: 4px solid #9dc23a; text-align:center;">
                        ...
                        <!-- accepted offers start-->
                        <div role="tabpanel" class="tab-pane fade in active" id="ContractCanceled_accept">
                            <div class="">
                                <div class="row mrgn30-0 projectRow no-padmr" style="border-left: 4px solid #80D651;">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#viewThisJob2" title="">
                                        ...
                                        <div class="col-sm-2 brdRight">
                                            ...
                                            <p class="mrgn0">Deliverdate:
                                                <br><span class="label label-default vd_bg-green vd_white">05-07-2017</span> </p>
                                        </div>
                                        <div class="col-sm-2">
